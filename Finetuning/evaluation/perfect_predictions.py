...
def check_predictions(prediction_folder, target_file, length_file):
    ...
    prediction_files=[f for f in os.listdir(prediction_folder) if "predictions" in f]

    prediction_files.sort()

    for f in prediction_files:
        prediction_file=os.path.join(prediction_folder, f)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="folder with all the predictions of the model for all the checkpoint",
    )
    ...
    check_predictions(args.prediction_folder, args.target_file, args. length_file)