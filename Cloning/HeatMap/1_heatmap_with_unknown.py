...
def create_all_heatmaps(excel_folder):
    ...
    for num_lines in range(2,6): # from 2 to 6 lines
        ...
        path_excel="{}/{}_False.xlsx".format(excel_folder, num_lines) # we ignore the files where we removed the unknown
    ...
    for num_lines in range(2,6): # from 2 to 6 lines
        ...
        # plt.title('heatmap')
        plt.savefig('result_cp_wp_{}lines.pdf'.format(num_lines), bbox_inches='tight',pad_inches = 0.1)  
